...
//   addToCart(product) {
//     console.log(this.cart.items, product._id);
...
//     });
//     console.log("cartP", cartProductIndex);
//     let newQuantity = 1;
//     // const updatedCartItems = {items: [{ productId: new ObjectId(product._id), quantity:newQuantity}]};
